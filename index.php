...
<body class="is-boxed">
    <div class="body-wrap boxed-container">
        <div class="button-group">
            <div>
                <a href="#home" class="active" id="navbutton"><svg aria-hidden="true" focusable="false" data-prefix="fas"
            ...
            <div>
                <a href="#geolocalisation" id="navbutton"><svg aria-hidden="true" focusable="false" data-prefix="fas"
            ...
            <div>
                <a href="#info" id="navbutton"><svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="info-circle"
        ...
        <main>
            <section class="hero text-center" id="home">
                ...
                <div class="containers">
                    <img src="public/images/feuille.jpg" class="feuille">
                </div>
                ...
                <div class="container-sm">
                    ...
                    <div class="hero-inner">
                        <div class="titregeo">
                            ...
                            <button id="loc-bt">Géolocalisation</button>
                        </div>
            ...
            <section class="features section text-center" id="info">
                <div class="container-sm">
                    <i class="fas fa-info-circle" id="logopage"></i>
                            ...
                            <div class="feature">
                                <div class="feature-inner">
                                    ...
                                    <p class="text-sm">Projet réalisé par une équipe jeune et motivée afin de dynamiser
                                        la recherche d'informations sur les médicaments commercialisés en France. Vous
                                        pouvez aussi rechercher et géolocaliser les pharmacies autour de vous. </p>
                                </div>
                            </div>
                            <div class="feature">
                                <div class="feature-inner">
